...
const Footer: React.FC = () => {
  return (
    <>
    <main className="bg-dark text-light mb-80 pb-12">
      <div className="container">
        <div className="grid grid-cols-4 gap-12">
          ...
          <div className="col-span-1 ml-16">
            ...
            <ul className="mt-10 space-y-6">
              <li>
                <a href="/" className="text-light text-sm uppercase font-luxury">
                  Watch
                </a>
              </li>
              <li>
          ...
          <div className="col-span-2">
            <span className="text-xs uppercase text-light/40">Instagram wall</span>
            
            <div className="mt-10 grid grid-cols-4 gap-4">
                <img src={img1} alt="" className="outline outline-light/20 shadow" />
                <img src={img1} alt="" className="outline outline-light/20 shadow" />
                <img src={img1} alt="" className="outline outline-light/20 shadow" />
                <img src={img1} alt="" className="outline outline-light/20 shadow" />
            </div>
        ...
        <div className="flex items-center justify-between text-sm">
          <p className="font-extralight">&copy; 2024 Makura. All Rights Reserved.</p>
    ...
    <section className="fixed bottom-0 w-full flex items-center justify-center -z-10">
        <img src={img1} alt="" className="w-full h-80 object-cover object-bottom" />
        <h2 className="absolute text-3xl text-light">Makura Proudly Made in Nepal</h2>
    </section>
    </>
  );
};
